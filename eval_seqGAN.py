...
def test(language, model_name):
    ...
    with open("eval_output/" + language + "_" + model_name + '_seqGAN.txt', "w+",
              encoding="utf-8") as f:
        with open('result/seqGAN.txt',"w+",encoding="utf-8") as f2:
            for name, get_data in zip(name_list, get_data_list):
                ...
                t="model/PA/seqGAN/"+language+"/"+str(nd[name])+"_seqGAN_qurey.npy"
