...
def test(language,model_name):
    ...
    with open("eval_output/"+language+"_"+model_name+'.txt',"w+",encoding="utf-8") as f:
        with open('result/qurey.txt',"w+",encoding="utf-8") as f2:
            for name,get_data in zip(name_list,get_data_list):
                ...
                for code,func,qurey in tqdm(get_data()):
